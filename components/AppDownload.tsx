...
interface AppDownloadProps {
  title: ReactNode;
  description: string;
  /** 第三顆 mesh blob 的色調。用 inline style 是因為 Tailwind 的 JIT 掃不到執行期組出來的 arbitrary value。 */
  glowTint?: string;
  homeHref?: string;
  homeLabel?: string;
  homeIcon?: LucideIcon;
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#0A0A0B]">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] animate-mesh-float [animation-delay:8s]"
          style={{ backgroundImage: `radial-gradient(circle, ${glowTint} 0%, transparent 70%)` }}
        />
